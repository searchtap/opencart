...
class ModelGsSearchtap extends Model {
    ...
    public function createTable() {
        $sql = "create table IF NOT EXISTS gs_searchtap (product_id int NOT NULL , last_updated_at TIMESTAMP, last_indexed_at TIMESTAMP, status varchar(100), primary KEY (product_id))";
        $query = $this->db->query($sql);
    }
